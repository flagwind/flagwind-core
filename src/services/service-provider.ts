...
import { IServiceStorage, ServiceStorage } from "./service-storage";
import { IServiceBuilder } from "./service-builder";
 ...
 * @version 1.0.0
 */
export abstract class ServiceProviderBase implements IServiceProvider
{
     ...
     * @param  {IServiceBuilder} builder? 服务生成器。
     */
    protected constructor(storage?: IServiceStorage, builder?: IServiceBuilder)
    {
 ...
 * @version 1.0.0
 */
export class ServiceProvider extends ServiceProviderBase
{
    /**
     * 初始化服务提供程序的新实例。
     * @param  {IServiceStorage} storage? 服务仓储实例。
    ...
    public constructor(storage?: IServiceStorage, builder?: IServiceBuilder)
    {
        ...
        if(!storage)
        {
            this._storage = new ServiceStorage(this);
        }
    }
}
